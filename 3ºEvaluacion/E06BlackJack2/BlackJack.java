...
public class BlackJack extends Applet implements Runnable {
    ...
    private void crearCartas() {
        for(int i = 0; i < NCARTAS; i++)
            cartaImagen[i] = getImage(getCodeBase(), "E06Ims" + ((i % CARTASXPALO) + 1) + palo[i/CARTASXPALO]);
        reverso = getImage(getCodeBase(), "E06Ims/reverso.png");
